...
public class JCity extends TableImpl<JCityRecord> {
     ...
     */
    public final TableField<JCityRecord, Integer> CITY_ID = createField(DSL.name("city_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<JCityRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("last_update"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public JCountry country() {
        if (_country == null)
            _country = new JCountry(this, Keys.FK_CITY_COUNTRY);
