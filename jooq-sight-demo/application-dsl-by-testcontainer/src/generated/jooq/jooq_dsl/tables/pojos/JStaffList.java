...
public class JStaffList implements Serializable {
    ...
    public JStaffList(JStaffList value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final JStaffList other = (JStaffList) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JStaffList (");
