...
public class StaffDao extends AbstractSpringDAOImpl<JStaffRecord, jooq.jooq_dsl.tables.pojos.JStaff, Integer> {
     ...
     * upperInclusive</code>
     */
    public List<jooq.jooq_dsl.tables.pojos.JStaff> fetchRangeOfJPicture(byte[] lowerInclusive, byte[] upperInclusive) {
     ...
     */
    public List<jooq.jooq_dsl.tables.pojos.JStaff> fetchByJPicture(byte[]... values) {
     ...
     * upperInclusive</code>
     */
    public List<jooq.jooq_dsl.tables.pojos.JStaff> fetchRangeOfJActive(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<jooq.jooq_dsl.tables.pojos.JStaff> fetchByJActive(Byte... values) {
