insert into jooq.author (first_name, last_name, date_of_birth, year_of_birth, distinguished)
values  ('George', 'Orwell', '1903-06-26', 1903, null),
        ('Paulo', 'Coelho', '1947-08-24', 1947, null);

insert into jooq.language (cd, description)
values  ('en', 'English'),
        ('de', 'Deutsch'),
        ('fr', 'Français'),
        ('pt', 'Português');

insert into jooq.book (author_id, title, published_in, language_id)
